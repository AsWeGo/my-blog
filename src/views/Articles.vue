      ...
      <main class="site-main">
        <article class="hentry">
          ...
          <div class="entry-content">
            ...
            <pre>
                <code>
curl -R -O http://www.lua.org/ftp/lua-5.3.5.tar.gz #下载
tar zxf lua-5.3.5.tar.gz #解压
cd lua-5.3.3 #进入解压文件夹
make linux test #安装&amp;测试</code>
            </pre>
            <hr />
            ...
            <ol>
              <li>
                ...
                <blockquote>
                  <p>
                    使用
                    <code>which gcc</code>命令可以查看是否有gcc，如果没有使用下面命令进行安装gcc 与gcc-c++，
                  </p>
...
yum -y install gcc-c++</code></pre>
            ...
            <blockquote>
              <p>
                执行
                <code>lua -v</code>,出现如下信息代表安装成功
                <br />Lua 5.1.4 Copyright (C) 1994-2008 Lua.org, PUC-Rio
              </p>
            </blockquote>
          ...
          <div class="open-message">
            <p>
              声明：极客小站博客|版权所有，违者必究|如未注明，均为原创|本网站采用
              <a href="https://creativecommons.org/licenses/by-nc-sa/3.0/" target="_blank">BY-NC-SA</a>协议进行授权
            </p>
            <p>
              转载：转载请注明原文链接 -
...
export default {
  ...
  methods: {
    getComment() {
      ...
      for (let i = 0; i < 5; i++) {
        List.push({
            content:"间放会土力技次时布象大业在级意制社运切研厂长住次北确去常写色山验条江调志具体把构级阶合约毛步往验",
            createTime:147016839801,
